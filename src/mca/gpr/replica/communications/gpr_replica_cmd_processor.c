 ...
 */
static int orte_gpr_replica_recv_delete_segment_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_put_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_get_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_delete_object_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_index_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_subscribe_cmd(orte_process_name_t* sender, orte_buffer_t *buffer);
static int orte_gpr_replica_recv_unsubscribe_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_synchro_cmd(orte_process_name_t* sender, orte_buffer_t *buffer);
static int orte_gpr_replica_recv_cancel_synchro_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_dump_cmd(orte_buffer_t *answer);
static int orte_gpr_replica_recv_get_startup_msg_cmd(orte_buffer_t *buffer, orte_buffer_t *answer);
static int orte_gpr_replica_recv_triggers_active_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_triggers_inactive_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_cleanup_job_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_cleanup_proc_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_notify_on_cmd(orte_buffer_t *buffer);
static int orte_gpr_replica_recv_notify_off_cmd(orte_buffer_t *buffer);
                            ...
                            orte_buffer_t *output_buffer)
{
	...
	case MCA_GPR_DELETE_SEGMENT_CMD:  /******    DELETE SEGMENT    *****/
	    ...
	    tmp_bool = orte_gpr_replica_recv_silent_mode(buffer);

	    if (OMPI_ERROR == (response = orte_gpr_replica_recv_delete_segment_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_PUT_CMD:  /*****    PUT    *****/
	    ...
	    if (OMPI_ERROR == (response = orte_gpr_replica_recv_put_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_GET_CMD:  /*****    GET    *****/
	    ...
	    if (NULL == (returned_list = orte_gpr_replica_recv_get_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_DELETE_OBJECT_CMD:  /*****     DELETE OBJECT     *****/
	    ...
	    if (OMPI_ERROR == (response = orte_gpr_replica_recv_delete_object_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_INDEX_CMD:  /*****     INDEX     *****/
	    ...
	    if (NULL == (returned_list = orte_gpr_replica_recv_index_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_SUBSCRIBE_CMD:  /*****     SUBSCRIBE     *****/
	    ...
	    if (OMPI_REGISTRY_NOTIFY_ID_MAX == (return_tag = orte_gpr_replica_recv_subscribe_cmd(sender, buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_UNSUBSCRIBE_CMD:  /*****     UNSUBSCRIBE     *****/
	    ...
	    if (OMPI_ERROR == (response = orte_gpr_replica_recv_unsubscribe_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_SYNCHRO_CMD:  /*****     SYNCHRO     *****/
	    ...
	    if (OMPI_REGISTRY_NOTIFY_ID_MAX == (return_tag = orte_gpr_replica_recv_synchro_cmd(sender, buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_CANCEL_SYNCHRO_CMD:  /*****     CANCEL SYNCHRO    *****/
	    ...
	    if (OMPI_ERROR == (response = orte_gpr_replica_recv_cancel_synchro_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_DUMP_CMD:  /*****     DUMP     *****/
	    ...
	    orte_gpr_replica_recv_dump_cmd(answer);
	    break;
	...
	case MCA_GPR_GET_STARTUP_MSG_CMD:  /*****     GET STARTUP MSG    *****/
	    ...
	    orte_gpr_replica_recv_get_startup_msg_cmd(buffer, answer);
	    break;
	...
	case MCA_GPR_NOTIFY_ON_CMD:  /*****     NOTIFY ON     *****/
	    ...
	    orte_gpr_replica_recv_notify_on_cmd(buffer);
	    break;
	...
	case MCA_GPR_NOTIFY_OFF_CMD:  /*****     NOTIFY OFF     ******/
	    ...
	    orte_gpr_replica_recv_notify_off_cmd(buffer);
	    break;
	...
	case MCA_GPR_TRIGGERS_ACTIVE_CMD:  /*****     TRIGGERS ACTIVE     *****/
	    ...
	    orte_gpr_replica_recv_triggers_active_cmd(buffer);
	    break;
	...
	case MCA_GPR_TRIGGERS_INACTIVE_CMD:  /*****     TRIGGERS INACTIVE     *****/
	    ...
	    orte_gpr_replica_recv_triggers_inactive_cmd(buffer);
	    break;
	...
	case MCA_GPR_CLEANUP_JOB_CMD:  /*****     CLEANUP JOB    *****/
	    ...
	    orte_gpr_replica_recv_cleanup_job_cmd(buffer);
	    break;
	...
	case MCA_GPR_CLEANUP_PROC_CMD:  /*****     CLEANUP PROCESS     *****/
	    ...
	    orte_gpr_replica_recv_cleanup_proc_cmd(buffer);
	    break;
	...
	case MCA_GPR_ASSIGN_OWNERSHIP_CMD:  /*****     ASSIGN OWNERSHIP     *****/
	    ...
	    if (OMPI_ERROR == (response = orte_gpr_replica_recv_assign_ownership_cmd(buffer))) {
		goto RETURN_ERROR;
	    }
	...
	case MCA_GPR_TEST_INTERNALS_CMD:  /*****     TEST INTERNALS     *****/
	    ...
	    returned_list = orte_gpr_replica_test_internals(test_level);
...
static int orte_gpr_replica_recv_delete_segment_cmd(orte_buffer_t *buffer)
{
    ...
    orte_gpr_replica_delete_segment_nl(seg);
...
static int orte_gpr_replica_recv_put_cmd(orte_buffer_t *buffer)
{
    ...
    orte_gpr_replica_segment_t *seg=NULL;
    orte_gpr_replica_key_t *keys=NULL;
    ...
    *tokptr = NULL;
    ...
    /* find the segment */
    seg = orte_gpr_replica_find_seg(true, segment, jobid);
    ...
    response = (int32_t)orte_gpr_replica_put_nl(mode, seg, keys, num_keys,
...
static int orte_gpr_replica_recv_get_cmd(orte_buffer_t *buffer)
{
	...
	*tokptr = NULL;
    ...
    orte_gpr_replica_get_nl(returned_list, mode, seg, keys, num_keys);
...
static int orte_gpr_replica_recv_delete_object_cmd(orte_buffer_t *buffer)
{
	...
	*tokptr = NULL;
    ...
    response = (int32_t)orte_gpr_replica_delete_object_nl(mode, seg, keys, num_keys);
...
static int orte_gpr_replica_recv_index_cmd(orte_buffer_t *buffer)
{
    ...
    returned_list = orte_gpr_replica_index_nl(seg);
...
static int orte_gpr_replica_recv_subscribe_cmd(orte_process_name_t* sender,
								    orte_buffer_t *buffer)
{
	...
	*tokptr = NULL;
    ...
    seg = orte_gpr_replica_find_seg(true, segment, owning_jobid);
    ...
    if (NULL != sender) {  /* remote sender */
		...
		local_idtag1 = orte_gpr_replica_enter_notify_request(seg, action, sender, id_tag, NULL, NULL);
	
		response = (int32_t)orte_gpr_replica_subscribe_nl(mode, action, seg, keys, num_keys,
		...
		response = (int32_t)orte_gpr_replica_subscribe_nl(mode, action, seg,
    ...
    orte_gpr_replica_check_subscriptions(seg, MCA_GPR_REPLICA_SUBSCRIBER_ADDED);
...
static int orte_gpr_replica_recv_unsubscribe_cmd(orte_buffer_t *buffer)
{
    ...
    response = (int32_t)orte_gpr_replica_unsubscribe_nl(sub_number);
...
static int orte_gpr_replica_recv_synchro_cmd(orte_process_name_t* sender,
								  orte_buffer_t *buffer)
{
#if 0
    ompi_registry_mode_t mode;
	...
	*tokptr = NULL;
    ...
    if (NULL != sender) {  /* remote sender */
        	...
        	/* enter request on local notify tracking system */
        	local_idtag1 = orte_gpr_replica_enter_notify_request(seg,
        							    OMPI_REGISTRY_NOTIFY_NONE, sender,
        							    id_tag, NULL, NULL);
        
        	response = (int32_t)orte_gpr_replica_synchro_nl(synchro_mode,
...
static int orte_gpr_replica_recv_cancel_synchro_cmd(orte_buffer_t *buffer)
{
    ...
    response = (int32_t)orte_gpr_replica_cancel_synchro_nl(synch_number);
...
#if 0
    OMPI_THREAD_LOCK(&orte_gpr_replica_mutex);
    orte_gpr_replica_dump_nl(answer);
    OMPI_THREAD_UNLOCK(&orte_gpr_replica_mutex);
#endif
    return ORTE_ERR_NOT_IMPLEMENTED;
}
...
{
#if 0
    orte_gpr_cmd_flag_t command=MCA_GPR_GET_STARTUP_MSG_CMD;
    mca_ns_base_jobid_t jobid=0;
    ...
    msg = orte_gpr_replica_construct_startup_msg_nl(jobid, recipients);
...
static int orte_gpr_replica_recv_triggers_active_cmd(orte_buffer_t *cmd)
{
#if 0
    mca_ns_base_jobid_t jobid=0;
    ...
    OMPI_THREAD_LOCK(&orte_gpr_replica_mutex);
    orte_gpr_replica_triggers_active_nl(jobid);
    OMPI_THREAD_UNLOCK(&orte_gpr_replica_mutex);
#endif
    return ORTE_ERR_NOT_IMPLEMENTED;
}

static int orte_gpr_replica_recv_triggers_inactive_cmd(orte_buffer_t *cmd)
{
#if 0
    mca_ns_base_jobid_t jobid=0;
    ...
    OMPI_THREAD_LOCK(&orte_gpr_replica_mutex);
    orte_gpr_replica_triggers_inactive_nl(jobid);
    OMPI_THREAD_UNLOCK(&orte_gpr_replica_mutex);
#endif
    return ORTE_ERR_NOT_IMPLEMENTED;
}

static int orte_gpr_replica_recv_cleanup_job_cmd(orte_buffer_t *cmd)
{
#if 0
    mca_ns_base_jobid_t jobid=0;
    ...
    OMPI_THREAD_LOCK(&orte_gpr_replica_mutex);
    orte_gpr_replica_cleanup_job_nl(jobid);
    OMPI_THREAD_UNLOCK(&orte_gpr_replica_mutex);
#endif
    return ORTE_ERR_NOT_IMPLEMENTED;
}
...
static int orte_gpr_replica_recv_cleanup_proc_cmd(orte_buffer_t *cmd)
{
#if 0
    ...
    OMPI_THREAD_LOCK(&orte_gpr_replica_mutex);
    orte_gpr_replica_cleanup_proc_nl(purge, &proc);
    OMPI_THREAD_UNLOCK(&orte_gpr_replica_mutex);
#endif
    return ORTE_ERR_NOT_IMPLEMENTED;
}
...
static int orte_gpr_replica_recv_notify_on_cmd(orte_buffer_t *cmd)
{
#if 0
    orte_process_name_t proc;
    ...
    OMPI_THREAD_LOCK(&orte_gpr_replica_mutex);
    orte_gpr_replica_notify_on_nl(&proc, sub_number);
    OMPI_THREAD_UNLOCK(&orte_gpr_replica_mutex);
#endif
    return ORTE_ERR_NOT_IMPLEMENTED;
}

static int orte_gpr_replica_recv_notify_off_cmd(orte_buffer_t *cmd)
{
#if 0
    orte_process_name_t proc;
    ompi_registry_notify_id_t sub_number;
    ...
    OMPI_THREAD_LOCK(&orte_gpr_replica_mutex);
    orte_gpr_replica_notify_off_nl(&proc, sub_number);
    OMPI_THREAD_UNLOCK(&orte_gpr_replica_mutex);
#endif
    return ORTE_ERR_NOT_IMPLEMENTED;
}
