...
static void orte_name_server_namelist_construct(orte_name_server_namelist_t* list)
{
    list->name = NULL;
}

/* destructor - used to free any resources held by instance */
static void orte_name_server_namelist_destructor(orte_name_server_namelist_t* list)
{
    if (NULL != list->name) {
	free(list->name);
    }
...
OBJ_CLASS_INSTANCE(
		   orte_name_server_namelist_t,              /* type name */
		   ompi_list_item_t,                        /* parent "class" name */
		   orte_name_server_namelist_construct,    /* constructor */
		   orte_name_server_namelist_destructor);  /* destructor */
