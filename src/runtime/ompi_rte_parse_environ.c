...
void ompi_rte_parse_environ(void)
{
	...
	orte_process_info.my_universe = strdup(enviro_val);
    }
	...
	orte_process_info.tmpdir_base = strdup(enviro_val);
    } else {
    ...
    ompi_universe_info.pid = orte_process_info.pid;
